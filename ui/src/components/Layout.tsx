            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={t("layout.switchToMode", { mode: nextTheme === "dark" ? t("layout.dark") : t("layout.light") })}
                  title={t("layout.switchToMode", { mode: nextTheme === "dark" ? t("layout.dark") : t("layout.light") })}
                >
