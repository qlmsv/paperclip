    ...
    <>
      ...
      >
        ...
        {uploadAttachment.isPending || importMarkdownDocument.isPending ? "Uploading..." : (
          <>
            <span className="hidden sm:inline">{t("issues.uploadAttachment")}</span>
      ...
      {(childIssuesLoading || childIssues.length > 0) && (
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-sm font-medium text-muted-foreground">{t("issues.subIssues")}</h3>
            <Button variant="outline" size="sm" onClick={openNewSubIssue} className="shadow-none">
              ...
              <span className="sm:hidden">{t("issues.subIssue")}</span>
            </Button>
          </div>
          {childIssuesLoading ? (
            ...
            <>
              ...
              {linkedRuns && linkedRuns.length > 0 && (
                <div className="mb-3 px-3 py-2 rounded-lg border border-border">
                  <div className="text-sm font-medium text-muted-foreground mb-1">{t("issues.costSummary")}</div>
